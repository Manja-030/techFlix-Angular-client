...
/**
 * Sends the form inputs to the back end to log in user
 * @function loginUser
 */
loginUser(): void {
    this.fetchApiData.userLogin(this.userCredentials.Username, this.userCredentials.Password).subscribe((result) => {
